...
class ExtractedInvoiceData(BaseModel):
    ...
    vendor_name: Optional[str] = Field(None, description="Name of the seller or vendor")
    vendor_gstin: Optional[str] = Field(None, description="15-digit GSTIN of the vendor if applicable")
    ...
    line_items: List[LineItem] = Field(default_factory=list, description="Itemized list of products/services")