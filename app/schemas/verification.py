...
class AuditFlag(BaseModel):
    code: str = Field(description="Error or rule code, e.g., INVALID_GSTIN, TAX_MISMATCH")
...
class DocumentAuditResult(BaseModel):
    ...
    flags: List[AuditFlag] = Field(default_factory=list, description="List of raised rule flags")