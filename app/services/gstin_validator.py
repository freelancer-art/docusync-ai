...
class GSTINValidatorService:
    STATE_CODES: ClassVar[dict[str, str]] = {
        "01": "Jammu & Kashmir",
        "02": "Himachal Pradesh",
        "03": "Punjab",
        "04": "Chandigarh",
    ...
    CHAR_MAP: ClassVar[str] = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ"
    ...
    def verify_gstin(cls, gstin: str) -> dict[str, Any]:
        ...
        return {
            ...
            else "Checksum digit verification failed",
        }
