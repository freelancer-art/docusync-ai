...
def create_sample_pdf(filename="storage/sample_uploads/test_invoice.pdf"):
    ...
    header_data = [
        [
            Paragraph(
                "<b>Vendor:</b><br/>Acme Solutions Pvt Ltd<br/>GSTIN: 27AAACA12341Z1<br/>Mumbai, MH"
            ),
            Paragraph(
                "<b>Invoice No:</b> INV-2026-089<br/><b>Date:</b> 2026-08-25<br/><b>Buyer:</b> Enterprise Systems Ltd<br/><b>Buyer GSTIN:</b> 27BBBCT99991Z5"
            ),
        ]
    ]
